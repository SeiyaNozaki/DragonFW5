...
module RBCP_REG_drs(
	...
	XD1Data,    //I2C_ADDR	v7
	XD2Data,    //I2C_CMD v7
	XD3Data,    //I2C_WRITEDATA v7
	XD4Data,    //I2C_READDATA v7
	XD5Data,
...
//-------- Input/Output -------------
	...
	output[7:0] X9DData;
	output[7:0] X9EData;
	//input[7:0] X9FData; //v5
	output[7:0] X9FData; //v7
	...
	output[7:0] XD0Data; //v7
	output[7:0] XD1Data; //v7
	output[7:0] XD2Data; //v7
	output[7:0] XD3Data; //v7
	input[7:0] XD4Data;  //v7
	input[7:0] XD5Data;  //v7
...
//	Registers
//------------------------------------------------------------------------------
	//reg[8'hCF:8]	regBe; //v5
	reg[8'hD3:8]	regBe; //v7

	always@ (posedge CLK or posedge RST) begin
		if(RST) begin
			//regBe[207:8] <= 200'd0; //v5
			regBe[211:8] <= 204'd0; //v7
		end else begin
...
//--------------------------------------
	...
	reg[7:0] regXD0Data; //v7
	reg[7:0] regXD1Data; //v7
	reg[7:0] regXD2Data; //v7
	reg[7:0] regXD3Data; //v7
	//reg[7:0] regXD4Data;
	//reg[7:0] regXD5Data;
	...
	always@ (posedge CLK or posedge RST) begin
		if(RST)begin
			...
			*/
			...
			if(regXD0Data[7:0] == 8'hff)begin //v7
				if(i2c_finish == 1'b1)begin
					regXD0Data[7:0] <= 8'h00;
				end
			end else if(regBe[208]) begin
				regXD0Data[7:0] <= regWd[7:0];
			end
			if(regBe[209]) begin //v7
				regXD1Data[7:0] <= regWd[7:0];
			end
			if(regBe[210]) begin //v7
				regXD2Data[7:0] <= regWd[7:0];
			end
			if(regBe[211]) begin //v7
				regXD3Data[7:0] <= regWd[7:0];
			end
			/* v7
			if(regBe[212]) begin
				regXD4Data[7:0] <= regWd[7:0];
			end
			if(regBe[213]) begin
				regXD5Data[7:0] <= regWd[7:0];
			end
			*/
		end
	end
	...
	assign X9FData[7:0] = regX9FData[7:0]; //v7
	...
	assign XD0Data[7:0] = regXD0Data[7:0]; //v7
	assign XD1Data[7:0] = regXD1Data[7:0]; //v7
	assign XD2Data[7:0] = regXD2Data[7:0]; //v7
	assign XD3Data[7:0] = regXD3Data[7:0]; //v7
	//assign XD4Data[7:0] = regXD4Data[7:0]; //v7
	//assign XD5Data[7:0] = regXD5Data[7:0]; //v7
//--------------------------------------
//	Read data mux.
//--------------------------------------
	reg		[7:0]	muxRegDataA		;
	...
	always@ (posedge CLK) begin
		case(regAddr[7:0])
			...
			8'hD0:   muxRegDataA[7:0] <= XD0Data[7:0]; //v7
			8'hD1:   muxRegDataA[7:0] <= XD1Data[7:0]; //v7
			8'hD2:   muxRegDataA[7:0] <= XD2Data[7:0]; //v7
			8'hD3:   muxRegDataA[7:0] <= XD3Data[7:0]; //v7
			8'hD4:   muxRegDataA[7:0] <= XD4Data[7:0]; //v7
			8'hD5:   muxRegDataA[7:0] <= XD5Data[7:0]; //v7
